...
class DrivingData : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:caffe.DrivingData) */ {
 public:
  ...
  // repeated .caffe.CarBoundingBox car_boxes = 3;
  int car_boxes_size() const;
  void clear_car_boxes();
  static const int kCarBoxesFieldNumber = 3;
...
class DriveDataParameter : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:caffe.DriveDataParameter) */ {
 public:
  ...
  // optional float hm_random_crop_ratio = 31 [default = 0];
  bool has_hm_random_crop_ratio() const;
  void clear_hm_random_crop_ratio();
  static const int kHmRandomCropRatioFieldNumber = 31;
  float hm_random_crop_ratio() const;
  void set_hm_random_crop_ratio(float value);
 ...
 private:
  ...
  inline void set_has_hm_random_crop_ratio();
  inline void clear_has_hm_random_crop_ratio();
...
// optional float hm_random_crop_ratio = 31 [default = 0];
inline bool DriveDataParameter::has_hm_random_crop_ratio() const {
  return (_has_bits_[0] & 0x40000000u) != 0;
}
inline void DriveDataParameter::set_has_hm_random_crop_ratio() {
  _has_bits_[0] |= 0x40000000u;
}
inline void DriveDataParameter::clear_has_hm_random_crop_ratio() {
  _has_bits_[0] &= ~0x40000000u;
}
inline void DriveDataParameter::clear_hm_random_crop_ratio() {
  hm_random_crop_ratio_ = 0;
  clear_has_hm_random_crop_ratio();
}
inline float DriveDataParameter::hm_random_crop_ratio() const {
  // @@protoc_insertion_point(field_get:caffe.DriveDataParameter.hm_random_crop_ratio)
  return hm_random_crop_ratio_;
}
inline void DriveDataParameter::set_hm_random_crop_ratio(float value) {
  set_has_hm_random_crop_ratio();
  hm_random_crop_ratio_ = value;
  // @@protoc_insertion_point(field_set:caffe.DriveDataParameter.hm_random_crop_ratio)
}
